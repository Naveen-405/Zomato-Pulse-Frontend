...
const Header = () => {
    ...
    useEffect(() => {
        if (location.pathname === '/') {
            setBackground('rgb(0,0,52)');
        } else {
            setBackground('rgb(0, 118, 132)')
        }
    }, [location.pathname])
        ...
        <div>
            ...
            <Modal id='login' isOpen={modalIsOpen} style={customStyles}>
                ...
                <div style={{ textAlign: 'center' }} className='px-5'>
                    <GoogleOAuthProvider clientId="972689664037-192it7hohoogfhdk7je3hi92otj2kj54.apps.googleusercontent.com">
                        <GoogleLogin
